...
def init():
    ...
    IMAGE = {
        'R1': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/R1.png').convert(), SIZE),
        'R2': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/R2.png').convert(), SIZE),
        'R3': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/R3.png').convert(), SIZE),
        'R4': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/R4.png').convert(), SIZE),
        'R5': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/R5.png').convert(), SIZE),
        'R6': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/R6.png').convert(), SIZE),
        'B1': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/B1.png').convert(), SIZE),
        'B2': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/B2.png').convert(), SIZE),
        'B3': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/B3.png').convert(), SIZE),
        'B4': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/B4.png').convert(), SIZE),
        'B5': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/B5.png').convert(), SIZE),
        'B6': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/B6.png').convert(), SIZE),
        'Y1': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/Y1.png').convert(), SIZE),
        'Y2': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/Y2.png').convert(), SIZE),
        'Y3': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/Y3.png').convert(), SIZE),
        'Y4': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/Y4.png').convert(), SIZE),
        'Y5': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/Y5.png').convert(), SIZE),
        'Y6': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/Y6.png').convert(), SIZE),
        '1': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/1.png').convert(), SIZE),
        '2': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/2.png').convert(), SIZE),
        '3': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/3.png').convert(), SIZE),
        '4': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/4.png').convert(), SIZE),
        '5': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/5.png').convert(), SIZE),
        '6': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/6.png').convert(), SIZE),
        'BLUEWIN': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/BLUEWIN.png').convert(), WINSIZE),
        'REDWIN': pygame.transform.scale(pygame.image.load(str(os.getcwd())+'\\picture/white/REDWIN.png').convert(), WINSIZE),
    }
    # 布局库
    maplib = [[6, 2, 4, 1, 5, 3],
              [6, 5, 2, 1, 4, 3],
...
def loadImage(name, pos, size=SIZE):
    ...
    filename = str(os.getcwd())+"\\picture/white/" + name
